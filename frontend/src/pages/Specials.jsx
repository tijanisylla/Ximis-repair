...
const Specials = () => {
  return (
    <div className="min-h-screen bg-brand-dark pt-36 lg:pt-44" data-testid="specials-page">
      {/* Hero */}
      <section className="max-w-7xl mx-auto px-6 lg:px-12 mb-20 text-center">
        ...
        <h1 className="font-heading text-5xl lg:text-7xl font-bold tracking-tight text-brand-cream mb-6">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 mb-24" data-testid="featured-promo">
        <div className="relative bg-gradient-to-br from-brand-maroon/20 via-brand-charcoal/50 to-brand-charcoal/50 border border-brand-maroon/20 p-10 lg:p-16 overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-heading text-5xl lg:text-7xl font-bold tracking-tight text-brand-cream mb-4">
                {BUSINESS.promo}
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/book">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-white/10 text-brand-cream/80 hover:bg-white/5 font-medium tracking-wide transition-all duration-300">
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="w-72 h-72 lg:w-80 lg:h-80 bg-brand-charcoal border border-white/10 flex items-center justify-center">
      ...
      {/* Other Specials */}
      <section className="py-24 lg:py-32 bg-brand-charcoal/30" data-testid="other-specials">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h2 className="font-heading text-3xl lg:text-4xl font-bold tracking-tight text-brand-cream mb-14 text-center">
            More Offers
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SPECIALS.map((special) => (
              <div 
                key={special.id}
                className={`bg-brand-charcoal/50 border p-8 transition-all duration-300 ${
                  special.active 
                    ? 'border-white/10 hover:border-brand-maroon/50 card-hover' 
              ...
              >
                ...
                <div className={`inline-flex items-center gap-2 px-3 py-1.5 mb-5 ${
                  ...
                  {special.active ? (
                    ...
                    <Clock className="w-3 h-3 text-brand-cream/40" />
                  )}
                  <span className={`text-xs tracking-wide ${
                    special.active ? 'text-green-500' : 'text-brand-cream/40'
                  }`}>
                ...
                {/* Content */}
                <h3 className="font-heading text-3xl font-bold tracking-tight text-brand-cream mb-2">
                  {special.title}
                </h3>
                ...
                <p className="text-brand-cream/40 text-xs mb-6 border-l-2 border-brand-maroon/30 pl-3">
                  {special.terms}
                </p>
                ...
                {special.active && (
                  <a href={BUSINESS.phoneLink}>
                    <Button 
                      variant="outline" 
                      className="w-full border-white/10 text-brand-cream/80 hover:bg-brand-maroon hover:text-white hover:border-brand-maroon font-medium text-sm tracking-wide transition-all duration-300"
                    >
      ...
      <section className="py-24 lg:py-32" data-testid="specials-bottom-cta">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <h2 className="font-heading text-3xl lg:text-4xl font-bold tracking-tight text-brand-cream mb-6">
